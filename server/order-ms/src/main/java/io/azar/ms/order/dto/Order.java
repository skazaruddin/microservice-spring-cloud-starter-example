...
public class Order {
	...
	public String toString() {
		return "Order [id=" + id + ", profileId=" + profileId + ", articleNumber=" + articleNumber + ", articleCode="
				+ articleCode + ", quantity=" + quantity + ", createdDate=" + createdDate + "]";
	}
